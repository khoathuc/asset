...
import { addRequestType, editRequestType } from "../action";
...
export function EditForm({
  ...
  const [default_followers, setDefaultFollowers] = useState<JsonArray>(requestType.default_followers as JsonArray || []);

  const method = useForm<RequestTypeFormData>({
    defaultValues: { allow_change_approvers: requestType.allow_change_approvers},
    resolver: zodResolver(requestTypeSchema),
  });
